...
class JSON_API_Post {
    ...
    function JSON_API_Post( $wp_post = null, $simple = false ) {
        if ( ! empty( $wp_post ) ) {
            $this->import_wp_object( $wp_post, $simple );
        }
    ...
    function import_wp_object( $wp_post, $simple = false ) {
    ...
    function set_featured_images() {
        ...
        $images           = $dynamic_featured_image->get_all_featured_images( $this->id );
