...
class JSON_API_Introspector {
    ...
    public function get_posts( $query = false, $wp_posts = false, $simple = false ) {
        ...
        while ( have_posts() ) {
            ...
            if ( $wp_posts ) {
                ...
                $new_post = new JSON_API_Post( $post, $simple );
            }
            $output[] = $new_post;
        }
    ...
    public function get_current_pageid() {
        global $json_api;
        extract( $json_api->query->get( array( 'index' ) ) );
