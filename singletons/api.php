...
class JSON_API {
    ...
    function admin_menu() {
        add_options_page( 'NutNote Settings', 'NutNote', 'manage_options', 'json-api', array(
            &$this,
            'admin_options'
        ) );
    }
    ...
    function admin_options() {
        ...
        <div class="wrap">
            ...
            <h2>NutNote Settings</h2>

            <form action="options-general.php?page=json-api" method="post">
                <?php wp_nonce_field( 'update-options' ); ?>
                <p>Specify a base URL for NutNote API.</p>
                <table class="form-table">
                    <tr valign="top">
                        <th scope="row">API base</th>
                        <td><code><?php bloginfo( 'url' ); ?>/</code><input type="text" name="json_api_base"
                                                                            value="<?php echo get_option( 'json_api_base', 'api' ); ?>"
                                                                            size="15"/></td>
                    </tr>
                </table>
                ...
                <p><strong>Note:</strong> User-friendly permalinks are not currently enabled. <a target="_blank"
                                                                                                 class="button"
                                                                                                 href="options-permalink.php">Change
                        Permalinks</a>
                    <?php } ?>
